...
func (in *InternalUser) DeepCopyInto(out *InternalUser) {
	*out = *in
...
func (in *InternalUser) DeepCopy() *InternalUser {
	if in == nil {
		return nil
	}
...
func (in *InternalUser) DeepCopyObject() runtime.Object {
...
func (in *InternalUserList) DeepCopyInto(out *InternalUserList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]InternalUser, len(*in))
		for i := range *in {
...
func (in *InternalUserList) DeepCopy() *InternalUserList {
	if in == nil {
		return nil
	}
	out := new(InternalUserList)
	in.DeepCopyInto(out)
	return out
}

func (in *InternalUserList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
func (in *InternalUserStatus) DeepCopyInto(out *InternalUserStatus) {
	*out = *in
	if in.StableServiceAccountRef != nil {
		out.StableServiceAccountRef = new(corev1.ObjectReference)
		*out.StableServiceAccountRef = *in.StableServiceAccountRef
	}
...
func (in *CredentialLease) DeepCopyInto(out *CredentialLease) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
func (in *CredentialLease) DeepCopy() *CredentialLease {
	if in == nil {
		return nil
	}
	out := new(CredentialLease)
	in.DeepCopyInto(out)
	return out
}

func (in *CredentialLease) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
func (in *CredentialLeaseList) DeepCopyInto(out *CredentialLeaseList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]CredentialLease, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *CredentialLeaseList) DeepCopy() *CredentialLeaseList {
	if in == nil {
		return nil
	}
	out := new(CredentialLeaseList)
	in.DeepCopyInto(out)
	return out
}

func (in *CredentialLeaseList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
func (in *CredentialLeaseStatus) DeepCopyInto(out *CredentialLeaseStatus) {
	*out = *in
	if in.ServiceAccountRef != nil {
		out.ServiceAccountRef = new(corev1.ObjectReference)
		*out.ServiceAccountRef = *in.ServiceAccountRef
	}
	if in.BoundSecretRef != nil {
		out.BoundSecretRef = new(corev1.ObjectReference)
		*out.BoundSecretRef = *in.BoundSecretRef
	}
	if in.BindingRef != nil {
		out.BindingRef = new(corev1.ObjectReference)
		*out.BindingRef = *in.BindingRef
	}
	if in.ConsumedAt != nil {
		out.ConsumedAt = in.ConsumedAt.DeepCopy()
	}
	if in.ApprovalExpirationTimestamp != nil {
		out.ApprovalExpirationTimestamp = in.ApprovalExpirationTimestamp.DeepCopy()
	}
	if in.RedeemedAt != nil {
		out.RedeemedAt = in.RedeemedAt.DeepCopy()
	}
	if in.ExpirationTimestamp != nil {
		out.ExpirationTimestamp = in.ExpirationTimestamp.DeepCopy()
	}
	if in.Conditions != nil {
		out.Conditions = make([]metav1.Condition, len(in.Conditions))
		for i := range in.Conditions {
